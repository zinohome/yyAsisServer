...
import io, base64
from aiengine.protocol import AudioMessage, TextMessage, AUDIO_TYPE
from aiengine.utils import log, httpxAsyncClient, wavToMp3, checkResponse
...
class CozeApiAsr(BaseASREngine): 
    ...
    async def run(self, input: AudioMessage, **kwargs) -> TextMessage:
        ...
        log.debug(f"[ASR] Engine response: {result}")
